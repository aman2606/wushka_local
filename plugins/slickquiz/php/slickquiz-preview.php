...
<div id="preview" class="quizPreview slickQuiz slickQuizWrapper">
    ...
    <div class="top_button_bar">
        <a class="button reload" href="#" title="Reload">
            <img alt="Reload" src="<?php echo plugins_url( '/images/arrow_refresh.png' , dirname( __FILE__ ) ); ?>"
                width="16" height="16" /> Reload
        </a>
        <?php if ( !isset( $_GET['readOnly'] ) ) { ?>
        <a class="button continueEditing" href="#" title="Continue Editing">
            <img alt="Continue Editing" src="<?php echo plugins_url( '/images/remove.png' , dirname( __FILE__ ) ); ?>"
                width="16" height="16" /> Continue Editing
        </a>
        <?php } else { ?>
        <a class="button continueEditing" href="#" title="Close">
            <img alt="Close" src="<?php echo plugins_url( '/images/remove.png' , dirname( __FILE__ ) ); ?>" width="16"
                height="16" /> Close
        </a>
        <?php } ?>
    </div>
    ...
    <div id="previewQuiz" class="SlickQuiz">
        ...
        <div class="quizArea">
            <div class="quizHeader">
                <div class="buttonWrapper"><a
                        class="button startQuiz"><?php $slickQuizPreview->get_admin_option( 'start_button_text', true ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="quizResults">
            <div class="quizResultsCopy">
                <h3 class="quizScore"><?php $slickQuizPreview->get_admin_option( 'your_score_text', true ); ?>
                    <span>&nbsp;</span>
                </h3>
                <h3 class="quizLevel"><?php $slickQuizPreview->get_admin_option( 'your_ranking_text', true ); ?>
                    <span>&nbsp;</span>
                </h3>
            </div>
        </div>
