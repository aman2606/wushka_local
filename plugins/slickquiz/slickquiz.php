...
if ( !class_exists( 'SlickQuiz' ) ) {
    class SlickQuiz
    {
        ...
        function __construct()
        {
            ...
            add_action( 'plugins_loaded', array( &$this, 'activate2' ) );
        ...
        function activate()
        {
            error_log("slickquiz activation hook");
        ...
        function load_resources()
        {
            ...
            wp_enqueue_script( 'slickquiz_admin_js', plugins_url( '/js/admin.js', __FILE__ ), '', 1.2 );
        ...
        function create_score_table()
        {
            ...
            $sql = "CREATE TABLE $table_name (
                ...
                book_id int(11),
                level int(11),
                quiz_pass boolean NOT NULL DEFAULT '0',                
                PRIMARY KEY  (id),
