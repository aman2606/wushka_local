 ...
 * @version    $Id: Image.php 331 2012-11-12 13:58:17Z jan $
 */

/**
 * The PDF stamp class
 * 
 * To initate an instance it is needed to pass a {@link SetaPDF_Core_Document document} instance to 
 * the consturctor. The snd parameter could be used to set the page number of the page which will be
...
class SetaPDF_Stamper_Stamp_Pdf extends SetaPDF_Stamper_Stamp
{
     ...
     * The constructor
     * 
     * @param SetaPDF_Core_Document|string $filenameOrDocument
     * @param integer $pageNumber
     * @param string $boundaryBox
     */
