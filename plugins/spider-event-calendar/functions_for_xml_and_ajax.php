...
<style>
  .dayevent-details-Heading{ font-family: ProximaNovaSoft-Bold, Arial, Helvetica, sans-serif; font-size:14px; }
  .dayevent-date-details{ font-family: ProximaNovaSoft-Bold, Arial, Helvetica, sans-serif; font-size:14px; }
  .dayevent-term-reference{ font-family: ProximaNovaSoft-Bold, Arial, Helvetica, sans-serif; font-size:14px; }
  .dayevent-repeat-details{ font-family: ProximaNovaSoft-Bold, Arial, Helvetica, sans-serif; font-size:14px; }
  .dayevent-details-body{ font-family: ProximaNovaSoft-Bold, Arial, Helvetica, sans-serif; font-size:14px; }
</style>
  ...
  <table style="height:100%;width:100%;background-color:<?php echo $show_event_bgcolor; ?>; border-spacing:0" align="center" id="pop_table">
    <tr>
      ...
      <td style="vertical-align:top; width:45%">
        ...
        echo '<div class="dayevent-details-Heading" style="font-size: 18px !important; padding:5px; text-align:center;border-bottom:1px solid #F3F3F3;color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . $activedatestr . '</div>';
        ...
        if ($row->date_end == '2070-12-12') {
          ...
          if ($row->date_end and $row->date_end != '0000-00-00') {
            echo '<div class="dayevent-date-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Date', 'sp_calendar') . ':' . str_replace("d", substr($row->date, 8, 2), str_replace("m", substr($row->date, 5, 2), str_replace("y", substr($row->date, 0, 4), $date_format1))) . '&nbsp;-&nbsp;' . str_replace("d", substr($row->date_end, 8, 2), str_replace("m", substr($row->date_end, 5, 2), str_replace("y", substr($row->date_end, 0, 4), $date_format1))) . '&nbsp;' . $row->time . '</div>';
          }
          else {
            echo '<div class="dayevent-time-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $font_weight . '; ' . $font_style . '  ">' . $row->time . '</div>';
          }
          if ($show_repeat == 1) {
            if ($row->repeat_method == 'daily') {

              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Day', 'sp_calendar') . '</div>';
            }
            if ($row->repeat_method == 'weekly') {
              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Week(s) on', 'sp_calendar') . ' : ';
            ...
            if ($row->repeat_method == 'monthly' and $row->month_type == 1) {
              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Month(s) on the', 'sp_calendar') . ' ' . $row->month . '</div>';
            }
            if ($row->repeat_method == 'monthly' and $row->month_type == 2) {
              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Month(s) on the', 'sp_calendar') . ' ' . week_number($row->monthly_list) . ' ' . week_convert($row->month_week) . '</div>';
            }
            if ($row->repeat_method == 'yearly' and $row->month_type == 1) {
              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Year(s) in', 'sp_calendar') . ' ' . date('F', mktime(0, 0, 0, $row->year_month + 1, 0, 0)) . ' ' . __('on the', 'sp_calendar') . ' ' . $row->month . '</div>';
            }
            if ($row->repeat_method == 'yearly' and $row->month_type == 2) {
              echo '<div class="dayevent-repeat-details" style="font-size:16px !important; color:' . $date_color . ';font-size:' . $date_size . 'px; font-family:' . $date_font . '; ' . $date_font_weight . '; ' . $date_font_style . '  ">' . __('Repeat Every', 'sp_calendar') . ' ' . $repeat . ' ' . __('Year(s) in', 'sp_calendar') . ' ' . date('F', mktime(0, 0, 0, $row->year_month + 1, 0, 0)) . ' ' . __('on the', 'sp_calendar') . ' ' . week_number($row->monthly_list) . ' ' . week_convert($row->month_week) . '</div>';
            }
          ...
          echo '<div class="dayevent-term-reference" style=" font-size:16px !important; padding-left:5px; border-left: 5px solid #'.str_replace('#','',$row_color).';color:' . $title_color . ';font-size:' . $title_size . 'px; font-family:' . $title_font . '; ' . $font_weight . '; ' . $font_style . '  ">' . $row_title . '</div>';
		  if ($row->text_for_date != '') {
          echo '<div class="dayevent-details-body" style="line-height:20px font-size:16px !important;">' . wpautop($row->text_for_date) . '</div>';
		  }
		   else {
	
          echo '<p class="dayevent-details-body" style="text-align:center; font-family:Arial, sans-serif; font-size:16px !important;">' . __('There Is No Text For This Event', 'sp_calendar') . '</p>';
        }
