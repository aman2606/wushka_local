<?php 
/* Notice Template 3 for Subscribed School */
...
<div class="notice-container notice-template-<?= $template; ?>">
    ...
    <div class="notice-content">
        ...
        <div class="notice-complete mt20">
            <!-- <p>Keen to learn more? Head to our Getting Started series here.</p> -->
        </div>
    </div>
</div>
<script>
    jQuery(document).ready(function($) {
        $(document).on('click', '.notice-template-<?= $template; ?> .close-notice a', function(e) {
            e.preventDefault();
            ajax_set_subscribed_notice_cookie();
        });

        function ajax_set_subscribed_notice_cookie() {
            $.ajax({
