...
return [
    'fields' => [
        ...
        'style' => [
            ...
            'show' =>
                '!$match(this.position, \'^(toolbar-(left|right)|(logo|navbar|header)(-mobile)?|dialog(-mobile)?|debug)$\')',
        ],
        'title_style' => [
            'label' => 'Title Style',
            'description' =>
        ...
        'maxwidth_align' => [
            ...
            'description' =>
                'Set how the widget should align when the container is larger than its max-width.',
            'type' => 'checkbox',
        ...
        'list_style' => [
            ...
            'show' =>
                '$match(this.type, \'recent-(comments|posts)|pages|archives|categories|meta\')',
        ],
        'link_style' => [
            'label' => 'Link Style',
