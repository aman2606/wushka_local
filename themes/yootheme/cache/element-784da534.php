<?php // $file = /home/wushkagm/public_html/wp-content/plugins/fs-table/includes/app/element/fs_table/element.json
...
return [
  ...
  'fields' => [
    ...
    'table_title_limit' => $config->get('fs-table.limit'),
    ...
    'table_title_style' => $config->get('fs-table.style'),
    'table_title_align' => [
      'label' => 'Alignment',
      'type' => 'checkbox',
    ...
    'table_title_decoration' => $config->get('fs-table.heading_decoration'),
    'table_title_font_family' => $config->get('fs-table.font_family'),
    'table_title_color' => [
      'label' => 'Color',
    ...
    'table_title_element' => $config->get('fs-table.element'),
    ...
    'table_title_margin' => $config->get('fs-table.margin'),
    'table_title_visibility' => $config->get('fs-table.visibility'),
    'table_meta_limit' => $config->get('fs-table.limit'),
    ...
    'table_meta_style' => $config->get('fs-table.style'),
    'table_meta_align' => [
      'label' => 'Alignment',
      'type' => 'checkbox',
      'text' => 'Force left alignment',
    ...
    'table_meta_decoration' => $config->get('fs-table.heading_decoration'),
    'table_meta_color' => $config->get('fs-table.color'),
    'table_meta_position' => [
      'label' => 'Position',
    ...
    'table_meta_element' => $config->get('fs-table.element'),
    'table_meta_margin' => $config->get('fs-table.margin'),
    'table_meta_visibility' => $config->get('fs-table.visibility'),
    'table_content_limit' => $config->get('fs-table.limit'),
    ...
    'table_content_style' => $config->get('fs-table.style'),
    'table_content_align' => [
      'label' => 'Alignment',
      'type' => 'checkbox',
      'text' => 'Force left alignment',
    ...
    'table_content_margin' => $config->get('fs-table.margin'),
    'table_content_visibility' => $config->get('fs-table.visibility'),
    'table_style' => [
      'label' => 'Style',
    ...
    'table_width_image' => [
      ...
      'type' => 'select',
      'options' => $config->get('fs-table.table_width_options'),
      'enable' => 'show_image',
      'show' => 'show_image'
    ],
    ...
    'title_limit' => $config->get('fs-table.limit'),
    'title_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '80',
    ...
    'title_style' => $config->get('fs-table.style'),
    'title_link' => [
      'label' => 'Link',
    ...
    'title_font_family' => $config->get('fs-table.font_family'),
    'title_color' => $config->get('fs-table.color'),
    'title_element' => $config->get('fs-table.element'),
    'title_align' => $config->get('fs-table.text_align'),
    ...
    'title_transform' => $config->get('fs-table.transform'),
    'title_margin' => $config->get('fs-table.margin'),
    'title_visibility' => $config->get('fs-table.visibility'),
    'label_visibility' => [
      'label' => 'Visibility',
      'description' => 'Show or hide the content on this device width and larger. If all elements are hidden, columns, rows and sections will hide accordingly.',
      'type' => 'select',
    ...
    'description_limit' => $config->get('fs-table.limit'),
    ...
    'description_style' => $config->get('fs-table.style'),
    'description_link' => [
      'label' => 'Link',
      'description' => 'Will wrap a field content inside a link.',
    ...
    'description_color' => $config->get('fs-table.color'),
    'description_align' => $config->get('fs-table.text_align'),
    'description_margin' => $config->get('fs-table.margin'),
    'description_visibility' => $config->get('fs-table.visibility'),
    'text_1_limit' => $config->get('fs-table.limit'),
    'text_1_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '10',
    ...
    'text_1_style' => $config->get('fs-table.style_label'),
    'text_1_label_color' => [
      'label' => 'Label',
    ...
    'text_1_font_family' => $config->get('fs-table.font_family'),
    'text_1_color' => $config->get('fs-table.color'),
    'text_1_element' => $config->get('fs-table.element'),
    'text_1_align' => $config->get('fs-table.text_align'),
    ...
    'text_1_transform' => $config->get('fs-table.transform'),
    'text_1_margin' => $config->get('fs-table.margin'),
    'text_1_visibility' => $config->get('fs-table.visibility'),
    'text_2_limit' => $config->get('fs-table.limit'),
    'text_2_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '20',
    ...
    'text_2_style' => $config->get('fs-table.style_label'),
    'text_2_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_2_font_family' => $config->get('fs-table.font_family'),
    'text_2_color' => $config->get('fs-table.color'),
    'text_2_element' => $config->get('fs-table.element'),
    'text_2_align' => $config->get('fs-table.text_align'),
    ...
    'text_2_transform' => $config->get('fs-table.transform'),
    'text_2_margin' => $config->get('fs-table.margin'),
    'text_2_visibility' => $config->get('fs-table.visibility'),
    'text_3_limit' => $config->get('fs-table.limit'),
    'text_3_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '30',
    ...
    'text_3_style' => $config->get('fs-table.style_label'),
    'text_3_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_3_font_family' => $config->get('fs-table.font_family'),
    'text_3_color' => $config->get('fs-table.color'),
    'text_3_element' => $config->get('fs-table.element'),
    'text_3_align' => $config->get('fs-table.text_align'),
    ...
    'text_3_transform' => $config->get('fs-table.transform'),
    'text_3_margin' => $config->get('fs-table.margin'),
    'text_3_visibility' => $config->get('fs-table.visibility'),
    'text_4_limit' => $config->get('fs-table.limit'),
    'text_4_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '40',
    ...
    'text_4_style' => $config->get('fs-table.style_label'),
    'text_4_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_4_font_family' => $config->get('fs-table.font_family'),
    'text_4_color' => $config->get('fs-table.color'),
    'text_4_element' => $config->get('fs-table.element'),
    'text_4_align' => $config->get('fs-table.text_align'),
    ...
    'text_4_transform' => $config->get('fs-table.transform'),
    'text_4_margin' => $config->get('fs-table.margin'),
    'text_4_visibility' => $config->get('fs-table.visibility'),
    'text_5_limit' => $config->get('fs-table.limit'),
    'text_5_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '50',
    ...
    'text_5_style' => $config->get('fs-table.style_label'),
    'text_5_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_5_font_family' => $config->get('fs-table.font_family'),
    'text_5_color' => $config->get('fs-table.color'),
    'text_5_element' => $config->get('fs-table.element'),
    'text_5_align' => $config->get('fs-table.text_align'),
    ...
    'text_5_transform' => $config->get('fs-table.transform'),
    'text_5_margin' => $config->get('fs-table.margin'),
    'text_5_visibility' => $config->get('fs-table.visibility'),
    'text_6_limit' => $config->get('fs-table.limit'),
    'text_6_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '60',
    ...
    'text_6_style' => $config->get('fs-table.style_label'),
    'text_6_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_6_font_family' => $config->get('fs-table.font_family'),
    'text_6_color' => $config->get('fs-table.color'),
    'text_6_element' => $config->get('fs-table.element'),
    'text_6_align' => $config->get('fs-table.text_align'),
    ...
    'text_6_transform' => $config->get('fs-table.transform'),
    'text_6_margin' => $config->get('fs-table.margin'),
    'text_6_visibility' => $config->get('fs-table.visibility'),
    'text_7_limit' => $config->get('fs-table.limit'),
    'text_7_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '70',
    ...
    'text_7_style' => $config->get('fs-table.style_label'),
    'text_7_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_7_font_family' => $config->get('fs-table.font_family'),
    'text_7_color' => $config->get('fs-table.color'),
    'text_7_element' => $config->get('fs-table.element'),
    'text_7_align' => $config->get('fs-table.text_align'),
    ...
    'text_7_transform' => $config->get('fs-table.transform'),
    'text_7_margin' => $config->get('fs-table.margin'),
    'text_7_visibility' => $config->get('fs-table.visibility'),
    'text_8_limit' => $config->get('fs-table.limit'),
    'text_8_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '80',
    ...
    'text_8_style' => $config->get('fs-table.style_label'),
    'text_8_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_8_font_family' => $config->get('fs-table.font_family'),
    'text_8_color' => $config->get('fs-table.color'),
    'text_8_element' => $config->get('fs-table.element'),
    'text_8_align' => $config->get('fs-table.text_align'),
    ...
    'text_8_transform' => $config->get('fs-table.transform'),
    'text_8_margin' => $config->get('fs-table.margin'),
    'text_8_visibility' => $config->get('fs-table.visibility'),
    'text_9_limit' => $config->get('fs-table.limit'),
    'text_9_limit_length' => [
      'label' => 'Characters',
      'description' => 'Sets the text limit output. Note: all HTML code will be stripped.',
      'default' => '80',
    ...
    'text_9_style' => $config->get('fs-table.style_label'),
    'text_9_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_9_font_family' => $config->get('fs-table.font_family'),
    'text_9_color' => $config->get('fs-table.color'),
    'text_9_element' => $config->get('fs-table.element'),
    'text_9_align' => $config->get('fs-table.text_align'),
    ...
    'text_9_transform' => $config->get('fs-table.transform'),
    'text_9_margin' => $config->get('fs-table.margin'),
    'text_9_visibility' => $config->get('fs-table.visibility'),
    'text_10_limit' => $config->get('fs-table.limit'),
    ...
    'text_10_style' => $config->get('fs-table.style_label'),
    'text_10_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_10_font_family' => $config->get('fs-table.font_family'),
    'text_10_color' => $config->get('fs-table.color'),
    'text_10_element' => $config->get('fs-table.element'),
    'text_10_align' => $config->get('fs-table.text_align'),
    ...
    'text_10_transform' => $config->get('fs-table.transform'),
    'text_10_margin' => $config->get('fs-table.margin'),
    'text_10_visibility' => $config->get('fs-table.visibility'),
    'text_11_limit' => $config->get('fs-table.limit'),
    ...
    'text_11_style' => $config->get('fs-table.style_label'),
    'text_11_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_11_font_family' => $config->get('fs-table.font_family'),
    'text_11_color' => $config->get('fs-table.color'),
    'text_11_element' => $config->get('fs-table.element'),
    'text_11_align' => $config->get('fs-table.text_align'),
    ...
    'text_11_transform' => $config->get('fs-table.transform'),
    'text_11_margin' => $config->get('fs-table.margin'),
    'text_11_visibility' => $config->get('fs-table.visibility'),
    'text_12_limit' => $config->get('fs-table.limit'),
    ...
    'text_12_style' => $config->get('fs-table.style_label'),
    'text_12_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_12_font_family' => $config->get('fs-table.font_family'),
    'text_12_color' => $config->get('fs-table.color'),
    'text_12_element' => $config->get('fs-table.element'),
    'text_12_align' => $config->get('fs-table.text_align'),
    ...
    'text_12_transform' => $config->get('fs-table.transform'),
    'text_12_margin' => $config->get('fs-table.margin'),
    'text_12_visibility' => $config->get('fs-table.visibility'),
    'text_13_limit' => $config->get('fs-table.limit'),
    ...
    'text_13_style' => $config->get('fs-table.style_label'),
    'text_13_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_13_font_family' => $config->get('fs-table.font_family'),
    'text_13_color' => $config->get('fs-table.color'),
    'text_13_element' => $config->get('fs-table.element'),
    'text_13_align' => $config->get('fs-table.text_align'),
    ...
    'text_13_transform' => $config->get('fs-table.transform'),
    'text_13_margin' => $config->get('fs-table.margin'),
    'text_13_visibility' => $config->get('fs-table.visibility'),
    'text_14_limit' => $config->get('fs-table.limit'),
    ...
    'text_14_style' => $config->get('fs-table.style_label'),
    'text_14_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_14_font_family' => $config->get('fs-table.font_family'),
    'text_14_color' => $config->get('fs-table.color'),
    'text_14_element' => $config->get('fs-table.element'),
    'text_14_align' => $config->get('fs-table.text_align'),
    ...
    'text_14_transform' => $config->get('fs-table.transform'),
    'text_14_margin' => $config->get('fs-table.margin'),
    'text_14_visibility' => $config->get('fs-table.visibility'),
    'text_15_limit' => $config->get('fs-table.limit'),
    ...
    'text_15_style' => $config->get('fs-table.style_label'),
    'text_15_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_15_font_family' => $config->get('fs-table.font_family'),
    'text_15_color' => $config->get('fs-table.color'),
    'text_15_element' => $config->get('fs-table.element'),
    'text_15_align' => $config->get('fs-table.text_align'),
    ...
    'text_15_transform' => $config->get('fs-table.transform'),
    'text_15_margin' => $config->get('fs-table.margin'),
    'text_15_visibility' => $config->get('fs-table.visibility'),
    'text_16_limit' => $config->get('fs-table.limit'),
    ...
    'text_16_style' => $config->get('fs-table.style_label'),
    'text_16_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_16_font_family' => $config->get('fs-table.font_family'),
    'text_16_color' => $config->get('fs-table.color'),
    'text_16_element' => $config->get('fs-table.element'),
    'text_16_align' => $config->get('fs-table.text_align'),
    ...
    'text_16_transform' => $config->get('fs-table.transform'),
    'text_16_margin' => $config->get('fs-table.margin'),
    'text_16_visibility' => $config->get('fs-table.visibility'),
    'text_17_limit' => $config->get('fs-table.limit'),
    ...
    'text_17_style' => $config->get('fs-table.style_label'),
    'text_17_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_17_font_family' => $config->get('fs-table.font_family'),
    'text_17_color' => $config->get('fs-table.color'),
    'text_17_element' => $config->get('fs-table.element'),
    'text_17_align' => $config->get('fs-table.text_align'),
    ...
    'text_17_transform' => $config->get('fs-table.transform'),
    'text_17_margin' => $config->get('fs-table.margin'),
    'text_17_visibility' => $config->get('fs-table.visibility'),
    'text_18_limit' => $config->get('fs-table.limit'),
    ...
    'text_18_style' => $config->get('fs-table.style_label'),
    'text_18_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_18_font_family' => $config->get('fs-table.font_family'),
    'text_18_color' => $config->get('fs-table.color'),
    'text_18_element' => $config->get('fs-table.element'),
    'text_18_align' => $config->get('fs-table.text_align'),
    ...
    'text_18_transform' => $config->get('fs-table.transform'),
    'text_18_margin' => $config->get('fs-table.margin'),
    'text_18_visibility' => $config->get('fs-table.visibility'),
    'text_19_limit' => $config->get('fs-table.limit'),
    ...
    'text_19_style' => $config->get('fs-table.style_label'),
    'text_19_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_19_font_family' => $config->get('fs-table.font_family'),
    'text_19_color' => $config->get('fs-table.color'),
    'text_19_element' => $config->get('fs-table.element'),
    'text_19_align' => $config->get('fs-table.text_align'),
    ...
    'text_19_transform' => $config->get('fs-table.transform'),
    'text_19_margin' => $config->get('fs-table.margin'),
    'text_19_visibility' => $config->get('fs-table.visibility'),
    'text_20_limit' => $config->get('fs-table.limit'),
    ...
    'text_20_style' => $config->get('fs-table.style_label'),
    'text_20_label_color' => [
      'label' => 'Color',
      'description' => 'Sets the label color.',
      'type' => 'select',
    ...
    'text_20_font_family' => $config->get('fs-table.font_family'),
    'text_20_color' => $config->get('fs-table.color'),
    'text_20_element' => $config->get('fs-table.element'),
    'text_20_align' => $config->get('fs-table.text_align'),
    ...
    'text_20_transform' => $config->get('fs-table.transform'),
    'text_20_margin' => $config->get('fs-table.margin'),
    'text_20_visibility' => $config->get('fs-table.visibility'),
    ...
    'image_align' => $config->get('fs-table.text_align'),
    ...
    'image_visibility' => $config->get('fs-table.visibility'),
    'show_button' => [
      'type' => 'checkbox',
    ...
    'sublayout_margin' => [
      ...
      'type' => 'select',
      'options' => $config->get('fs-table.margin_options'),
