<style>
    ...
    #hero {
        background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/img/pages/students-using-wushka-classroom.jpg');
    ...
    @media screen and (max-width: 992px) {
        #hero {
            background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/img/pages/students-wushka-ipad@2x.jpg');
        }
        .icons {
            justify-content: space-around;
        }
