...
<html <?php language_attributes(); ?>>
    <head>
        <style type="text/css">
           ...
           .splash-banner.faq-1 {
     			background: url('<?php echo get_stylesheet_directory_uri() . '/img/info_pp_1.jpg'; ?>');
     		}
            .splash-banner.faq-2 {
				background: url('<?php echo get_stylesheet_directory_uri() . '/img/info_tc_1.jpg'; ?>');
          	}
			...
			jQuery(document).ready(function($) {
				$(document).on('click', 'a[href="#faq-1"]', function(e){
					if ( $('.splash-banner').hasClass('faq-2') ) {
						$('.splash-banner').toggleClass('faq-1');
						$('.splash-banner').toggleClass('faq-2');
					}
				});
        ...
        <div class="wrapper-main">
            ...
            <section class="section banner-section splash-banner col-lg-12 faq-1">
	        	<div class="banner-text heading">
	               <h1 class="hero-heading page-heading banner-header">Useful Information</h1>
	        	   <h2 class="sub-heading">Read the Fineprint</h2>
	            </div>
	        </section>
<main role="main">
			...
			<div class="row">
				...
				<div class="feature-faq col-sm-9 panel-group" id="faq-wrap" role="tablist" aria-multiselectable="true">
					<div class="panel panel-default" role="tab">
						<a href="#faq-1" class="panel-link" data-toggle="collapse" data-parent="#faq-wrap" aria-expanded="false" aria-controls="faq-1"><div class="panel-heading">Privacy Policy</div></a>
						<div class="panel-body collapse" id="faq-1">
					  	</div>
					</div>
					<div class="panel panel-default" role="tab">
						<a href="#faq-2" class="panel-link" data-toggle="collapse" data-parent="#faq-wrap" aria-expanded="false" aria-controls="faq-2"><div class="panel-heading">Terms and Conditions</div></a>
