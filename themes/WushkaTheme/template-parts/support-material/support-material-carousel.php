                                                    ...
                                                    <div class="bookshelf-item-wrapper">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="icon-wrapper">
                                                                <div class="icon-square" <?= $day_week_border; ?>>
                                                                    <span class="icon-letter" id="iconLetter"><?php echo esc_html( $card->icon_text ); ?></span>
                                                                </div>
                                                        ...
                                                        <div class="action-buttons">
                                                            ...
                                                            <?php if ( $card->secondary_link && $card->secondary_link !== '#' ) : ?>
                                                                <?php if ( is_user_logged_in() ) : ?>
                                                                    <a href="<?php echo esc_url( $card->post_link ).'?sm_type=slideshow&id='.$card->secondary_link; ?>" class="secondary-button" target="_blank">
                                                                        <span <?php echo $panel_heading_back ?? ''; ?>>
