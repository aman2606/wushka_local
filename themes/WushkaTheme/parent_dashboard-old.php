...
?>
<script>
    var add_new_user_data_path = '<?php echo get_stylesheet_directory_uri() . '/db_add-new-user.php'; ?>';
    var edit_child_data_path   = '<?php echo get_stylesheet_directory_uri() . '/edit-children-data.php'; ?>';
</script>
