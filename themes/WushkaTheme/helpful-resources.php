...
<div class="helpful-resources-wrap">
    <div class="">
        <div class="b1">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/b-green-orange.webp"
                    type="image/webp">
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-green-orange.png"
                    type="image/jpeg">
        ...
        <div class="b2">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/b2-purple-s2.webp"
                    type="image/webp">
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b2-purple-s2.png"
                    type="image/jpeg">
        ...
        <div class="b3">
            <picture>
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/b-orange.webp"
                    type="image/webp">
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-orange.png"
                    type="image/jpeg">
        ...
        <div class="b4">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/b-purple-orange.webp"
                    type="image/webp">
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-purple-orange.png"
                    type="image/jpeg">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-purple-orange.png" alt="">
            </picture>
        </div>
        <div class="b5">
            <picture>
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/b-blue.webp"
                    type="image/webp">
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-blue.png"
                    type="image/jpeg">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/b-blue.png" alt="">
            </picture>
        </div>
    </div>
    <div id="hero">
            ...
            <div class="container">
                ...
                <div class="row getting-wrap">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <picture>
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/program-coordinator-easy-setup-guide.webp"
                                type="image/webp">
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/program-coordinator-easy-setup-guide.jpg"
                                type="image/jpeg">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/program-coordinator-easy-setup-guide.jpg"
                        ...
                        <a href="#"
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/download.svg"
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <picture>
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/teacher-user-easy-setup-guide.webp"
                                type="image/webp">
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/teacher-user-easy-setup-guide.jpg"
                                type="image/jpeg">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/teacher-user-easy-setup-guide.jpg"
                        ...
                        <a href="#"
                            ...
                            aria-label="Teacher User Set Up Guide (New Window)" class="btn btn-blue download-btn"><img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/download.svg"
                                alt="" class="download-icon" /> Download</a>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <picture>
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/my-school-login-details.webp"
                                type="image/webp">
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/my-school-login-details.jpg"
                                type="image/jpeg">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/my-school-login-details.jpg"
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <a href="//www.youtube.com/embed/8WeMKIexQ7o" id="activate-your-account" class="video btn-play-video">
                                        ...
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/yt-play-icon.svg"
                                            alt="" />
                                    </a>
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#activate-your-account').click();" tabindex="-1" class="btn-play-video-layer">
                                        <span class="sr-only">Play: Activating Your Account</span>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/activating-your-account.png"
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    ...
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#manage-class-lists').click();" tabindex="-1" class="btn-play-video-layer">
                                        <span class="sr-only">Play: Setting Up for Independent and Guided Reading using 'Manage Class Lists'</span>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/manage-class-lists.png"
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    ...
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#manage-reading-groups').click();" tabindex="-1" class="btn-play-video-layer">
                                        <span class="sr-only">Play: Setting Up Reading Groups Using 'Manage Reading Groups'</span>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/manage-reading-groups.png"
                                            class="video-thumb" alt="" />
                                    </a>
            ...
            <div class="container">
                ...
                <div class="row first-child">
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <picture>
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/reading-level-correlation-chart.webp"
                                type="image/webp">
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/reading-level-correlation-chart.jpg"
                                type="image/jpeg">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/reading-level-correlation-chart.jpg"
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <picture>
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/webp/national-curriculum-links.webp"
                                type="image/webp">
                            <source
                                srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/national-curriculum-links.jpg"
                                type="image/jpeg">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/national-curriculum-links.jpg"
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    ...
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#what-is-wushka').click();" tabindex="-1" class="btn-play-video-layer">
                                        <span class="sr-only">Play: What Is Wushka?</span>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/what-is-wushka.png?ver=1.1"
                                            alt="" class="video-thumb" />
                                    </a>
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    ...
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#wushka-webinar').click();" tabindex="-1" class="btn-play-video-layer">
                                        <span class="sr-only">Play: Wushka Webinar</span>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/wushka-webinar.png"
                                            class="video-thumb" alt="" />
                                    </a>
                            ...
                            <div class="video-wrapper">
                                <div class="embed-responsive embed-responsive-16by9">
                                    ...
                                    <a href="#" onclick="event.preventDefault(); javascript:$('#st-hilda').click();" tabindex="-1" class="btn-play-video-layer">
                                        ...
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/see-why-st-hilda-love-using-wushka.png"
                                            class="video-thumb" alt="" />
                                    </a>
