    ...
    <div class="hero-container">
        <div class="container">
            <div class="row">
                ...
                <img src="<?= get_stylesheet_directory_uri(); ?>/img/rollover.svg" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row mb60">
                        <div class="col-sm-4 col-xs-4 col-xsl-12">
                            <a href="<?php echo $video_embed_url; ?>" class="video rollover-block-btn">
                                <img src="<?= get_stylesheet_directory_uri(); ?>/img/rollover-watch.svg" alt="">
                                <strong>WATCH</strong>
                        ...
                        <div class="col-sm-4 col-xs-4 col-xsl-12">
                            <a href="<?= $how_to_guid_pdf; ?>" class="rollover-block-btn" target="_blank">
                                <img src="<?= get_stylesheet_directory_uri(); ?>/img/rollover-read.svg" alt="">
                                <strong>READ</strong>
                        ...
                        <div class="col-sm-4 col-xs-4 col-xsl-12">
                            <a href="<?php echo $webinar_link; ?>" class="rollover-block-btn" target="_blank">
                                <img src="<?= get_stylesheet_directory_uri(); ?>/img/rollover-learn.svg" alt="">
                                <strong>LEARN</strong>
                    ...
                    <!-- div class="text-center mb50">
                        ...
                        <img src="<?= get_stylesheet_directory_uri(); ?>/img/notice-2023.png" alt="" style="width: 350px">
                    </div -->
...
<script src="<?= get_stylesheet_directory_uri(); ?>/js/modaal.min.js"></script>
