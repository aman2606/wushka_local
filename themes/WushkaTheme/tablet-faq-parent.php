<?php
/*
  Template Name: Tablet-faq-parent
 */
?>
<?php
global $current_user;
    ...
    <head>
        <style type="text/css">
            ...
            .section.banner-section.splash-banner {
                ...
                background-image: url('<?php echo get_stylesheet_directory_uri() . '/img/faq_2.jpg'; ?>');
            ...
            @-webkit-keyframes splashbanner {
                0%   {background-image: url('<?php echo get_stylesheet_directory_uri() . '/img/class_hands2.jpg'; ?>');}
                33%  {background-image: url('<?php echo get_stylesheet_directory_uri() . '/img/class_hands2.jpg'; ?>');}
        ...
        <!-- Fonts -->
        <link href="<?php echo get_stylesheet_directory_uri(); ?>/css/glyphicons.css" rel="stylesheet">
        <link href="<?php echo get_stylesheet_directory_uri(); ?>/css/glyphicons-bootstrap.css" rel="stylesheet">

        <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/style.css">
        <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/dataTable.css">

        <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/bootstrap.min.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.dataTable.js"></script>
        <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.jeditable.js"></script>
        ...
        <div class="wrapper-main">
            ...
            <section class="section banner-section splash-banner col-lg-12">
                <div class="banner-text heading">
                    ...
                    <h2 class="sub-heading">For Parents and Students</h2>
                </div>
            </section>
<main role="main">
				...
				<div class="panel-group feature-faq col-sm-9" id="faq-wrap" role="tablist" aria-multiselectable="true">
					<div class="panel panel-default" role="tab">
						<a href="#faq-1" class="panel-link" data-toggle="collapse" data-parent="#faq-wrap"  aria-expanded="false" aria-controls="faq-1"><div class="panel-heading">General</div></a>
					  	<div class="panel-body collapse" id="faq-1">
							...
							<p>Yes. Wushka‘s literacy programme aligns to the English curriculum however it is not intended to be used as a standalone program. Wushka provides parents with a means of utilising 21st-century, digital technologies to what their child is doing in the classroom. </p>
							<p>As stated in the Australian curriculum*, literacy programs should aim ‘to development students’ ability to interpret and create texts with appropriateness, accuracy, confidence, fluency and efficacy for learning in and out of school’. Wushka provides a safe platform where your child can feel free to experiment and make mistakes on this journey and where parents can easily monitor their ongoing progress. </p>
							<p>Wushka also allows for an integrated approach to literacy that is dynamic and relevant to the world of today’s generation. With an ever increasing need for the successful integration of multimodal texts, Wushka’s digital library ensures technologies are integrated into your child's life in a relevant and educational way. </p>
							<p>(*http://www.australiancurriculum.edu.au/english/content-structure/literacy)</p>
							<p><b>How can you as a parent use Wushka to support your child's reading?</b></p><p>Wushka has been designed to cater for a range of abilities and to give you the freedom to use as many or as few of the features that match your child’s needs. Ensuring that your child has a supportive environment that promotes a love of reading has been proven to facilitate the development of literacy skills. Having the Wushka narration adds another level of support where your child can continue to read without always needing assistance.</p>
							<p><b>How are the eBooks levelled?</b></p>
							<p>The eBooks within the Wushka library have been carefully aligned to different reading levels from Magenta (Levels 1-2) through to Black (Levels 31 ++) similar to a reading recovery system. The different shelves cater for a range of abilities so that you can select the most appropriate books for your child's needs.  </p>
							<p><b>Who has written the Wushka eBooks?</b></p>
							<p>Our eBooks have been created by a team of teachers, authors and designers and are published by world-renowned publisher, Learning Media. Each book has been carefully written and formatted with the aim of helping children develop their literacy skills and a love of reading. If you have further ideas for topics you would like to see covered in our library please contact us at <a href="mailto:publisher@wushka.com.au">publisher@wushka.com.au</a>.</p>
					  	</div>
					</div>
					<div class="panel panel-default" role="tab">
					  	...
					  	<div class="panel-body collapse" id="faq-2">
							...
							<p>To sign up for a Wushka home membership visit our <a href="/subscription">Parent Subscription page</a>. If you need further assistance, please do not hesitate to contact us at <a href="mailto:support@wushka.com.au">support@wuhska.com.au</a>.</p>
							...
							<p>Yes, of course however, we do not have any special subscription for home schooling.</p>
							<p><b>I have an individual membership. Can I share my password with others?</b></p>
							<p>Members have unlimited access to the site for their own personal use. Sharing of personal login and password information is therefore prohibited. Accounts are monitored for this activity and may be suspended if evidence of login and password sharing is found.</p>
							...
							You can easily renew your subscription at any time after cancelling it, by visiting <a href-"/my-account/">My Account</a> and clicking ‘Renew’ under the ‘My Subscriptions’ tab.However, you will need to begin the subscription process again and provide your credit card details for payment.</p>
					  	</div>
					</div>
					<div class="panel panel-default" role="tab">
					...
					<div class="panel panel-default" role="tab">
					  	...
					  	<div class="panel-body collapse" id="faq-4">
							...
							<p>Yes, every eBook can be read with audio. If your child’s account is linked to a school account their teacher may have disabled this feature. Please check this with this with your child’s teacher. To begin the audio when using the eReader, press the play button, located in the top left hand corner of the screen.</p>
							...
							<p>On the completion of an eBook, your child provides a rating as to their individual preference and how difficult they found the eBook. They can simply select the number of stars to indicate there preference level and then separately indicate, the eBook’s degree of difficulty. This feature will need to be explained to your child but it is simple to use then without further assistance.</p>
							<p><b>How are the quizzes relevant to the reading level? </b></p>
							<p>As the books become more advanced, so do the questions. Lower level quizzes use questions that determine recall and a basic understanding of the main ideas and concepts found within the text. Quizzes then progress into prompting your child to apply and analyse knowledge. In the highest levels, they are provided with questions that encourage synthesis and evaluation of hypothetical scenarios related to the text.</p>
					  	</div>
					</div>
					<div class="panel panel-default" role="tab">
