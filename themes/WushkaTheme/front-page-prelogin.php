            ...
            <div class="row">
                        ...
                        <a href="/levelled-library" title="Levelled Library">
                            <div class="row reading-library ">
                                ...
                                <div class="col-md-2 chevron-container">
                                    <div class="chev">
                                        <img class="chevron-image chevron-grey" src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron.svg" alt>
                                        <img class="chevron-image chevron-white" src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron-white.svg" alt>
                ...
                <div class="reading-libraries">
                    ...
                    <div class="row reading-library">
                        ...
                        <div class="col-md-2 chevron-container">
                            <div class="chev">
                                <img class="chevron-image" src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron.svg" alt>
                                <div class="circle-container">
                                    <div class="chev">
                                        <img class="chevron-image chevron-grey" src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron.svg" alt>
                                        <img class="chevron-image chevron-white" src="<?php echo get_stylesheet_directory_uri(); ?>/images/chevron-white.svg" alt>
                ...
                <div class="col-xs-12 text-center dummy-video">
                    <div align="center" class="embed-responsive embed-responsive-16by9 video-item-wrapper">
                        ...
                        <video id="video1" controls="controls" width="100%" height="100%" preload="auto"
                               ...
                               poster="<?php echo get_stylesheet_directory_uri(); ?>/build/video-poster.png">
