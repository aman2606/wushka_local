  ...
  ?>
        ...
        <section>
            ...
            <section class="article-content">
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/reading-boxes.webp"
                            type="image/webp" />
                        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/reading-boxes.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/reading-boxes.png"
            ...
            <div id="article-popup" class="container hide">
                <div class="popup-close-wrapper">
                    <button type="button" class="popup-close popup-btn" aria-label="close">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/menu-close.svg"
                            alt="Close" />
                    </button>
                </div>
                <section class="popup-content">
                    ...
                    <div class="popup-zoom-buttons">
                        <button type="button" class="popup-btn popup-zoom-in">
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/plus.svg" alt="" />
                        </button>
                        <button type="button" class="popup-btn popup-zoom-out" disabled>
                            <span class="sr-only">Zoom Out</span>
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/minus.svg" alt="" />
                        </button>
                    </div>
                    <div class="article-text">
            ...
            <section class="article-content">
                ...
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/support-materials.webp"
                            type="image/webp" />
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/support-materials.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/support-materials.png"
            ...
            <section class="article-content">
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/quizzes.webp"
                            type="image/webp" />
                        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/quizzes.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/quizzes.png"
            ...
            <section class="article-content">
                ...
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/class-management.webp"
                            type="image/webp" />
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/class-management.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/class-management.png"
            ...
            <section class="article-content">
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/reading-groups.webp"
                            type="image/webp" />
                        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/reading-groups.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/reading-groups.png"
            ...
            <section class="article-content">
                ...
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/statistics.webp"
                            type="image/webp" />
                        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/statistics.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/statistics.png"
            ...
            <section class="article-content">
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/school-management.webp"
                            type="image/webp" />
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/school-management.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/school-management.png"
            ...
            <section class="article-content">
                ...
                <div class="article-image flex-center">
                    ...
                    <picture>
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/student-dashboard.webp"
                            type="image/webp" />
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/student-dashboard.png"
                            type="image/png" />
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/student-dashboard.png"
    ...
    <div class="bubbles">
        <div class="b1">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-green.webp"
                    type="image/webp" />
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-green.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-green.png"
                    alt="" />
            </picture>
        </div>
        ...
        <div class="b2">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-orange-small.webp"
                    type="image/webp" />
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-orange-small.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-orange-small.png"
                    alt="" />
            </picture>
        </div>
        ...
        <div class="b3">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-purple.webp"
                    type="image/webp" />
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-purple.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-purple.png"
                    alt="" />
            </picture>
        </div>
        ...
        <div class="b4">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-orange-large.webp"
                    type="image/webp" />
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-orange-large.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-orange-large.png"
                    alt="" />
            </picture>
        </div>
        ...
        <div class="b5">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-mix.webp"
                    type="image/webp" />
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-mix.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-mix.png" alt="" />
            </picture>
        </div>
        ...
        <div class="b6">
            <picture>
                <source
                    srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/webp/bubbles-blue.webp"
                    type="image/webp" />
                <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-blue.png"
                    type="image/png" />
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/extra/bubbles-blue.png" alt="" />
            </picture>
        </div>
    </div>
</main>
...
function createPopup(i) {
    ...
    const baseUrl = "<?php echo get_stylesheet_directory_uri(); ?>";
...
const articlePopUp = '<div id="article-popup" class="container hide">' +
    '<div class="popup-close-wrapper">' +
    '<button type="button" class="popup-close popup-btn" aria-label="close">' +
    '<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/how-it-works/menu-close.svg" alt="Close"/>' +
    '</button>' +
    '</div>' +
    '<section class="popup-content">' +
    '<div class="article-image">' + 
