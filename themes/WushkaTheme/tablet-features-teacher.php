    ...
    <head>
        <style type="text/css">
            ...
            .section.banner-section.splash-banner {
                ...
                background-image: url('<?php echo get_stylesheet_directory_uri() . '/img/feature_school_4.jpg'; ?>');
	    	...
	    	<div class="features" style="background:#50B4D0;">
	        	<div class="row">
	            	<div class="col-sm-7 feature-image feature-1">
	                	<img class="img-responsive" title="Teacher Dashboard" src="<?php echo get_stylesheet_directory_uri() . '/img/feature_school_1.jpg'; ?>" />
	    	...
	    	<div class="features" style="background:#693F69;">
	        	<div class="row">
	                ...
	                <div class="col-sm-7 feature-image">
	                	<img class="img-responsive" title="Manage Class List" src="<?php echo get_stylesheet_directory_uri() . '/img/feature_school_2.jpg'; ?>" />
<!-- 	            		<div class="dummy-image">Insert Image Here</div> -->
	                </div>
	            </div>
	       	</div>
        ...
        <div class="feature-set col-sm-8">
	    	<div class="features" style="background:#C71E24;">
	        	<div class="row">
	            	<div class="col-sm-7 feature-image">
	            		<img class="img-responsive" title="Student Statistics" src="<?php echo get_stylesheet_directory_uri() . '/img/feature_school_3.jpg'; ?>" />
<!-- 	            		<div class="dummy-image">Insert Image Here</div> -->
	                </div>
	                <div class="col-sm-5 feature-text">
	                	<div class="feature-glyph">
