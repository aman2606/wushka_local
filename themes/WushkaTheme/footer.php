<?php
// On YOOtheme builder pages use the parent theme's footer to properly close
// the HTML structure that the parent's header.php opened.
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0">
                    <?php wp_nav_menu(array('theme_location' => 'footer-nav-social')); ?>
                </div>
                <?php /* ?>
            <div class="col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0">
