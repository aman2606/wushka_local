            ...
            <div class="row about-block">
                ...
                <div class="col-sm-12 col-md-6 col-lg-5">
                    <picture class="mobile">
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/about-us/webp/img-about-us-wushka.webp"
                            type="image/webp">
                        <source
                            srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/about-us/img-about-us-wushka.jpg"
                            type="image/jpeg">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/about-us/img-about-us-wushka.jpg"
                            alt="About us">
                    </picture>
                </div>
            </div>
                        ...
                        <div class="video-wrapper">
                            <div class="embed-responsive embed-responsive-16by9">
                                <a href="//www.youtube.com/embed/8Ml-AzYJoxM" class="video btn-play-video" id="what-is-wushka" aria-label="What is Wushka?">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/yt-play-icon.svg" alt="Youtube" />
                                </a>
                                <a href="#" onclick="event.preventDefault(); javascript:$('#what-is-wushka').click();" tabindex="-1" class="btn-play-video-layer"><img
                                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/activating-your-account.png"
                        ...
                        <div class="video-wrapper">
                            <div class="embed-responsive embed-responsive-16by9">
                                <a href="//www.youtube.com/embed/S-Ou7KcneBI" class="video btn-play-video" id="st-hilda" aria-label="St Hilda love using Wushka">
                                  ...
                                  <img
                                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/yt-play-icon.svg"
                                        alt="Youtube" /></a>
                                <a href="#" onclick="event.preventDefault(); javascript:$('#st-hilda').click();" tabindex="-1" class="btn-play-video-layer">
                                <img
                                        src="<?php echo get_stylesheet_directory_uri(); ?>/img/helpful-resources/see-why-st-hilda-love-using-wushka.png"
