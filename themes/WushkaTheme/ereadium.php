...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/readium-all.css">
    ...
    <script type="text/javascript"
        src="<?php echo get_stylesheet_directory_uri(); ?>/scripts/readium-js-viewer_all_LITE.js?ver=2.01"></script>
    <script>
