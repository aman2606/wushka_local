                    ...
                    ?>
                        ...
                        <div class="form-group">
                            <a href="<?php echo esc_url(add_query_arg('sso', 'nsw_doe')); ?>" class="btn btn-primary btn-block other-login-btn" title="Login with NSW Department of Education">
                                <img src="<?= get_stylesheet_directory_uri(); ?>/img/nsw-government-logo.svg" alt="">
                                Login with NSW DOE
                            </a>
                        </div>
                    <?php    }    ?>
            ...
            <div class="QR_login">
                ...
                <div class="camera_activation_section">
                    <div class="activate_camera btn btn-primary btn-block open_scanner">
                        <span class="cas_camera_icon"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/icon_camera.png" /></span><span class='ca_text'>Click here to Activate Camera</span>
                        <div class="cas_cursor">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/cursor.png" />
                        </div>
                    </div>
                    ...
                    /*<div class="cas_watch_video btn btn-block">
                        <span class="cas_video_icon"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/icon_play.png" /></span class='ca_text'><span>Watch the Video here</span>
                    </div>*/
                    ?>
...
<section class="container mt70 pb70 login_with_QR" style="display:none;">
    <div class="clearfix">
        <div class="stop_scanner btn btn-primary"><span class="back_icon"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/icon_back.png" /></span><span>Back</span></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 reader-col">
                <img class="qr_place" src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/qrcode_frame.png" />
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 qr_code_image">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/images/QR/qrcode_image_2.png" />
            </div>
