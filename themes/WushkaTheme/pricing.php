...
<div class="pricing-wrap">
  <div class="bubbles">
    ...
    <div class="b2">
      <picture>
        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/decodable-library/webp/bubblrs-red.webp" type="image/webp">
        <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/decodable-library/bubblrs-red.png" type="image/jpeg">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="pricing-table">
              <div class="row-title">
                <picture>
                  <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/levelled-library-icon.webp" type="image/webp">
                  <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/levelled-library-icon.png" type="image/jpeg">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/levelled-library-icon.png" alt="Levelled Library" class="icon-thumb">
                </picture>
                ...
                <table class="compare-table" role="presentation">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="td"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/tick-green.svg" alt="True" class="tick-true"></td>
                    </tr>
                    <tr>
                      <th class="th heading">Decodable ebooks</th>
                      <td class="td"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/tick-grey.svg" alt="" class="tick-true"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="td last-child">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/tick-green.svg" alt="True" class="tick-true">
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
              ...
              <div class="close-func"><a onclick="show(0)" class="closeBtn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/close.svg" alt=""> Close</a></div>
            </div>
          </div>
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="pricing-table">
                <div class="row-title">
                  <picture>
                    <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/decodable-library-icon.webp" type="image/webp">
                    <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/decodable-library-icon.png" type="image/jpeg">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/decodable-library-icon.png" alt="Decodable Library" class="icon-thumb">
                  </picture>
                ...
                <div class="see" style="display:none;">
                  <table class="compare-table" role="presentation">
                    ...
                    <tr>
                      <th class="th heading last-child">Professional development available</th>
                      <td class="td last-child"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/tick-green.svg" alt="True" class="tick-true"/>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
              ...
              <div class="close-func"><a onclick="show(1)" class="closeBtn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/close.svg" alt=""> Close</a></div>
              </div>
            </div>
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="pricing-table">
                <div class="row-title">
                  <picture>
                    <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/plus-icon.webp" type="image/webp">
                    <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/plus-icon.png" type="image/jpeg">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/plus-icon.png" alt="Wushka Plus" class="icon-thumb">
                  </picture>
              ...
              <div class="close-func"><a onclick="show(2)" class="closeBtn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/close.svg" alt=""> Close</a></div>
              </div>
            </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-5 com-lg-4">
          <picture class="img-block">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/try-before-you-buy.webp" type="image/webp">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/try-before-you-buy.png" type="image/jpeg">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/try-before-you-buy.png" class="buy-thumb" alt="Try before you buy">
          </picture>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-5 com-lg-4">
          <picture class="img-block desktop">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/want-to-upgrade.webp" type="image/webp">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/want-to-upgrade.png" type="image/jpeg">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/want-to-upgrade.png" class="upgrade-thumb" alt="Buy Decodable Readers in Print">
          </picture>
          <picture class="img-block tablet">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/webp/want-to-upgrade-tablet.webp" type="image/webp">
            <source srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/want-to-upgrade-tablet.png" type="image/jpeg">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pricing/want-to-upgrade-tablet.png" class="upgrade-thumb" alt="Buy Decodable Readers in Print">
          </picture>
        </div>
      </div>
    </div>
